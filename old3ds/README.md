...
using the 3DS Y2R hardware converter into linear RGB565 staging buffers copied
into RGB565 top framebuffers. A slow software RGB565 renderer is only used as a
