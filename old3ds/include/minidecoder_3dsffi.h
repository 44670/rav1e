...
size_t o3yv_frame_decoder_size(void);
size_t o3yv_frame_decoder_align(void);
...
int32_t o3yv_frame_decoder_init(void *decoder, size_t decoder_len);
int32_t o3yv_frame_decoder_reset(void *decoder);
int32_t o3yv_frame_decoder_next_frame(
    void *decoder, const uint8_t *frame, size_t frame_len,
    O3yvFrameInfo *info);
int32_t o3yv_frame_decoder_write_current_yuv420p(
    void *decoder, uint8_t *left_yuv420p, size_t left_len,
    uint8_t *right_yuv420p, size_t right_len);
int32_t o3yv_frame_decoder_current_frame_planes(
    const void *decoder, O3yvEyePlanes *left, O3yvEyePlanes *right);
void o3yv_frame_decoder_drop(void *decoder);
